    ...
    do{
        ...
        switch(op1){
            case 1:
                ...
                switch(op2){
                    case 1: arr = Nova_guitarra(&TAM, arr, 1);
                        break;
                    case 2: HistoricoGuitarra(list);
                        break;
                    case 3: MostraInfo(arr, &TAM, 0);
                        break;
                    case 4: MostraInfo(arr, &TAM, 1);
                        break;
                    case 5: 
                        break;
                } 
